    ...
    render() {
        ...
        return (
            <div tankName = {this.props.tankInfo.name}>
                ...
                {this.state.clicked ? <h3>Introduced: {this.props.tankInfo.era}</h3> : null}
                {this.state.clicked ? <p>Strengths: {this.props.tankInfo.strengths}</p> : null}
                {this.state.clicked ? <p>Weaknesses: {this.props.tankInfo.weaknesses}</p> : null}
            </div>
        )
    }
